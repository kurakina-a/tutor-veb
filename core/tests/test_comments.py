...
from ..models import Answer, Comment, Option, Question, Student, Teacher, Test
...
class CommentsBackendTests(TestCase):
    ...
    def test_empty_comment_is_not_saved(self):
        ...
        self.client.post(reverse("add_comment", args=[self.answer.id]), {"text": ""})
